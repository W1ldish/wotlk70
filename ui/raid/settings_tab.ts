...
export class SettingsTab extends SimTab {
  ...
  private buildConsumesSettings() {
    ...
    this.makeBooleanRaidIconBuffInput(container, ActionId.fromItemId(33461), 'scrollOfStamina'),
		this.makeBooleanRaidIconBuffInput(container, ActionId.fromItemId(33462), 'scrollOfStrength'),
		this.makeBooleanRaidIconBuffInput(container, ActionId.fromItemId(33457), 'scrollOfAgility'),
		this.makeBooleanRaidIconBuffInput(container, ActionId.fromItemId(33458), 'scrollOfIntellect'),
		this.makeBooleanRaidIconBuffInput(container, ActionId.fromItemId(33460), 'scrollOfSpirit'),
		this.makeBooleanRaidIconBuffInput(container, ActionId.fromItemId(33459), 'scrollOfProtection');
  }
