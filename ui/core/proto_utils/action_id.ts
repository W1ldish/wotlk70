...
export const resourceTypeToIcon: Record<ResourceType, string> = {
	...
	[ResourceType.ResourceTypeBloodRune]: '/wotlk70/assets/img/blood_rune.png',
	[ResourceType.ResourceTypeFrostRune]: '/wotlk70/assets/img/frost_rune.png',
	[ResourceType.ResourceTypeUnholyRune]: '/wotlk70/assets/img/unholy_rune.png',
	[ResourceType.ResourceTypeDeathRune]: '/wotlk70/assets/img/death_rune.png',
};
