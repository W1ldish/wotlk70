	...
	rogue.DeadlyPoison = rogue.RegisterSpell(core.SpellConfig{
		...
		Dot: core.DotConfig{
			...
			OnTick: func(sim *core.Simulation, target *core.Unit, dot *core.Dot) {
				baseDmg := (51 + 0.027*dot.Spell.MeleeAttackPower()) * float64(dot.GetStacks())
...
func (rogue *Rogue) makeInstantPoison(procSource PoisonProcSource) *core.Spell {
	...
	return rogue.RegisterSpell(core.SpellConfig{
		ActionID:    core.ActionID{SpellID: 26891, Tag: int32(procSource)},
		SpellSchool: core.SpellSchoolNature,
		ProcMask:    core.ProcMaskSpellDamage,
		...
		ApplyEffects: func(sim *core.Simulation, target *core.Unit, spell *core.Spell) {
			baseDamage := 161 + 0.1*spell.MeleeAttackPower()
			if isShivProc {
